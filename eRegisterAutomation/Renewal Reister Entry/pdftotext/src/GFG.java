...
public class GFG {
     ...
     public static void xlfunc(String maindirpath) throws Exception
    {
         ...
         XSSFSheet spreadsheet = workbook.createSheet(" Premium Collection Register ");
     	  
         XSSFRow row;
      
         Map<String, Object[]> studentData = new TreeMap<String, Object[]>();
     	        
         studentData.put(String.valueOf(1), new Object[] { "Policy No", "NAME", "Fup","Premium","Cash","Cheque","ChequeNo/Date","Mode","Agency Cd","Transaction No","Date","Merchant Id" });
