...
public class GFG {
     ...
     public static void xlfunc(String maindirpath) throws Exception
    {
         ...
         XSSFSheet spreadsheet = workbook.createSheet("BOC Register ");
     	  
         XSSFRow row;
      
         Map<String, Object[]> studentData = new TreeMap<String, Object[]>();
     	        
         studentData.put(String.valueOf(1), new Object[] { "Prop Name","BOC No", "Date", "Amount","Cash","Cheque","ChequeNo","Agency Cd","Agent Name","Merchant Id" });
